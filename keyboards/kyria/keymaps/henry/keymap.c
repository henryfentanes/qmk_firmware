...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = LAYOUT(
      ...
      ZOOM_MUTE, TD(TAB_ALT_OR_ALTSHIFT), TD(ENTER_CMD_OR_CMDSHIFT), KC_LSFT, LT(PYCHARM_MACROS,KC_SPC),                            MT(MOD_LALT,KC_TAB), MT(MOD_LSFT,KC_SPC), LT(NAV_AND_NUMBERS,KC_SPC),  KC_BSPC, PRINT_SCREEN
    ),
	[SHIFTED_QWERTY] = LAYOUT(
      ...
      KC_TRNS, TD(TAB_ALT_OR_ALTSHIFT), TD(ENTER_CMD_OR_CMDSHIFT), KC_LSFT,LT(PYCHARM_MACROS,KC_SPC),                                 MT(MOD_LALT,KC_TAB), KC_TRNS, LT(NAV_AND_NUMBERS,KC_SPC),  KC_TRNS, PRINT_SCREEN
	  ),
	[PYCHARM_MACROS] = LAYOUT(
	  KC_TRNS,    KC_EXLM,   KC_AT,   PYCHARM_BACK_TO_EDITOR,KC_RCBR,PYCHARM_BACK_TO_TERMINAL,                                                                       KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_LPRN,   KC_RPRN,   KC_PPLS,
	  KC_TRNS,   KC_HASH,   KC_MPRV,    KC_MPLY,    KC_MNXT,   KC_GRV,                                                                                              KC_HOME,   KC_PGDN,   KC_PGUP,   KC_END,   KC_LCBR,   KC_RCBR,
