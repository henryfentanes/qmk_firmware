...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = LAYOUT(
      LT(2,KC_ESC),    KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,                                                    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_MINS,
      MT(MOD_LCTL,KC_TAB),      KC_A,   KC_S,   KC_D,   KC_F,   KC_G,                                           KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,
      ZOOM_MUTE_UNMUTE,      KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,  MT(MOD_LALT,KC_BSPC),  PYCHARM_DEBUGGER_TOOL,  KC_NO,  EMOJIS,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_PIPE,
      PRINT_SCREEN_COPY, TD(TAB_ALT_OR_ALTSHIFT), LT(2,KC_BSPC), TD(ENTER_CMD_OR_CMDSHIFT), MT(MOD_LSFT,KC_ENT),  MT(MOD_LSFT,KC_ENT), LT(2,KC_SPC), MT(MOD_LALT,KC_BSPC),  LT(1,KC_BSPC), PRINT_SCREEN
    ),
	[SHIFTED_QWERTY] = LAYOUT(
	  KC_GRV,    KC_EXLM,   KC_AT,   PYCHARM_BACK_TO_EDITOR,  KC_RCBR,   PYCHARM_BACK_TO_TERMINAL,                                                                  KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_LPRN,   KC_RPRN,   KC_PPLS,
	  KC_TRNS,   KC_HASH,   KC_MPRV,    KC_MPLY,    KC_MNXT,   KC_GRV,                                                              KC_HOME,   KC_PGDN,   KC_PGUP,   KC_END,   KC_LCBR,   KC_RCBR,
	  KC_TRNS,   KC_PERC,   KC_CIRC,   PYCHARM_BACK_TO_CONSOLE,   KC_RBRC,   KC_TILD,  PYCHARM_RUN_TEST,   PYCHARM_DEBUG_TEST,                KC_TRNS,   EMOJIS,   KC_AMPR,   KC_NO,   KC_COMM,   KC_DOT,   KC_SLSH,   KC_BSLS,
	  PRINT_SCREEN,   TD(TAB_ALT_OR_ALTSHIFT ),    KC_BSPC,   TD(ENTER_CMD_OR_CMDSHIFT),   MT(MOD_LSFT,KC_ENT),   MT(MOD_LSFT,KC_ENT),   KC_SPC,   MT(MOD_LALT,KC_BSPC),   KC_NO,   PRINT_SCREEN_COPY
	  ),
	[NAV_AND_NUMBERS] = LAYOUT(
	  ...
	  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE, KC_VOLD, KC_BTN1, KC_BTN2,                KC_NO, EMOJIS, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NO, KC_BSLS,
	  PRINT_SCREEN, TD(TAB_ALT_OR_ALTSHIFT), KC_BSPC, TD(ENTER_CMD_OR_CMDSHIFT), MT(MOD_LSFT,KC_ENT), MT(MOD_LSFT,KC_ENT), KC_SPC, MT(MOD_LALT,KC_BSPC), KC_TAB, PRINT_SCREEN_COPY)
};
